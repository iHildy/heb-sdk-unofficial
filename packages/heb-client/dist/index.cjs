...
__export(index_exports, {
  ...
  getCredentialsFromEnv: () => getCredentialsFromEnv,
  ...
  login: () => login,
  nextDataRequest: () => nextDataRequest,
  parseCookies: () => parseCookies,
  parseJwtExpiry: () => parseJwtExpiry,
  persistedQuery: () => persistedQuery,
  quickAdd: () => quickAdd,
  removeFromCart: () => removeFromCart,
  reserveCurbsideSlot: () => reserveCurbsideSlot,
...
async function login(credentials, options = {}) {
  ...
  if (userDataDir) {
    ...
    context = await import_playwright.chromium.launchPersistentContext(userDataDir, {
      headless,
      channel: "chrome",
