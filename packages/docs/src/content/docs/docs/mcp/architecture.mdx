...
This is the high-level flow for heb-mcp-unofficial in local and hosted modes.
...
Local sessions load from `HEB_SAT`/`HEB_REESE84` or `~/.heb-sdk-unofficial/cookies.json`, and the file watcher reloads automatically.
